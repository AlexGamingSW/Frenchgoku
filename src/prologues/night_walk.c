...
void night_walk_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(gSpriteHandler, anim_night_walk_prologue_title, 0, 106, 128, 0, 0, 0x7f, 0);
    gPrologueEngineData->playYanSprite = sprite_create(gSpriteHandler, anim_night_walk_prologue_play_yan, 0, 50, 120, 0, 0, 0x7f, 0);
    gPrologueEngineData->balloonsSprite = sprite_create(gSpriteHandler, anim_night_walk_prologue_balloons, 0, 50, 120, 0, 1, 0, 0);
}
