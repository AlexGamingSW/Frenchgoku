...
void cafe_print_dialogue(void) {
    ...
    switch (dialogueTask) {
        case CAFE_EV_INIT_DIALOGUE:
            ...
            if (playtime <= 20) {
                ...
                string = "\n"
                         ...
                         "avec ces jeux de rythme‡R?\n"
                         "Continuez comme ˆ¹a‡R!\n";
            } else if (playtime <= 60) {
                // Aren't you getting tired?
                // Don't forget to rest now and then.
                string = "\n"
                         "Est-ce que vous commencez\n"
                         "‡g fatiguer‡R? C'est bien de faire\n"
                         "une pause de temps en temps.\n";
            } else {
                // You've been at this a while,
                // haven't you? Please rest a little.
                string = "\n"
                         "Vous n'avez pas chˆ¶m‡Q, n'est-ce pas‡R?\n"
                         "Vous ne voudriez pas faire une pause‡R?\n"
                         "\n";
            }
        ...
        case CAFE_EV_START_TOPIC:
            ...
            switch (topic) {
                case CAFE_TOPIC_CAMPAIGN_CLEAR:
                    ...
                    s = gCafe->string;
                    memcpy(s, "", 1);
                    strcat(s, "Alors, il paraˆ²t que vous\n");
                    strcat(s, "avez termin‡Q le jeu\n");
                    strcat(s, "\0051" "\0015");
                    strcat(s, levelName);
                    strcat(s, "\0054" "\0018" "\nsur un Parfait‡R!\n");
                    string = s;
                ...
                case CAFE_TOPIC_TROUBLE_GETTING_MEDAL:
                    ...
                    s = gCafe->string;
                    memcpy(s, "", 1);
                    strcat(s, "Hum... ‡g propos du jeu\n");
                    strcat(s, "\0051" "\0015");
                    strcat(s, levelName);
                    strcat(s, "\0054" "\0018" "...\n");
                    strcat(s, "Est-ce que vous avez du mal ‡g\n");
                    strcat(s, "obtenir sa m‡Qdaille‡R?\n");
                    string = s;
        ...
        case CAFE_EV_OFFER_CLEAR_00:
            ...
            // "Please skip it."
            // "No, thank you."
            string = "Si vous voulez, je peux vous\n"
                     "faire " "\0051" "\0015" "passer directement au\n"
                     "jeu suivant" "\0054" "\0018" ". Qu'en dites-vous‡R?\n"
                     "@@@@@@@@@@@@@@á‡RTout ‡g fait‡R!‡Râ\n"
                     "@@@@@@@@@@@@@@á‡RNon merci.‡Râ";
        ...
        case CAFE_EV_OFFER_CLEAR_02_Y:
            ...
            string = "Je me demande quels seront les\n"
                     "prochains jeux‡R? J'esp‡are qu'ils\n"
                     "vous donneront la motivation\n"
                     "n‡Qcessaire‡R! ‡f la prochaine.";
            dialogueExhausted = TRUE;
            break;
        ...
        case CAFE_EV_CAMPAIGN_ADVICE_00:
            ...
            //         "Not right now."
            string = "\0054" "\0018" "\n"
                     "\0054" "\0018" "Est-ce que vous vous entraˆ²nez\n"
                     "\0054" "\0018" "pour " "\0051" "\0015" "r‡Qaliser un Parfait" "\0054" "\0018" "‡R?\n"
                     "@@@@@@@@@@@@@á‡RTout ‡g fait‡R!‡Râ\n"
                     "@@@@@@@@@@@@@á‡RPas du tout.‡Râ";
            gCafe->queryEnabled = TRUE;
            gCafe->queryResult = CAFE_OPT_YES;
        ...
        case CAFE_EV_UPCOMING_CAMPAIGN_00:
            ...
            // go get that Perfect!
            string = "\n"
                     "Je pense que vous pouvez y\n"
                     "arriver‡R! Je croise les doigts\n"
                     "pour vous‡R!\n";
            dialogueExhausted = TRUE;
            break;
        ...
        case CAFE_EV_ALL_CAMPAIGNS_CLEAR_00:
            ...
            string = "\n"
                     "Il paraˆ²t que que vous avez enfin\n"
                     "obtenu tous les Parfaits‡R!\n"
                     "...Est-ce que c'est vrai‡R?";
            dialogueTask++;
            break;
