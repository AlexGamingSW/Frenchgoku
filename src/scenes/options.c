...
static const char *options_scene_bitmap_get_value(s32 entry) {
    switch (entry) {
        case OPTIONS_BITMAP_NON_JP_SFX:
            return CHECK_ADVANCE_FLAG(D_030046a8->data.advanceFlags, ADVANCE_FLAG_NON_JP_SFX) ? "‚e‚’‚‚Ž‚¨‚‚‰‚“" : "‚i‚‚‚‚Ž‚‚‰‚“";

        case OPTIONS_BITMAP_NON_JP_MUSIC:
            return CHECK_ADVANCE_FLAG(D_030046a8->data.advanceFlags, ADVANCE_FLAG_NON_JP_MUSIC) ? "‚e‚’‚‚Ž‚¨‚‚‰‚“" : "‚i‚‚‚‚Ž‚‚‰‚“";
#ifdef RUMBLE
        case OPTIONS_BITMAP_RUMBLE:
            return CHECK_ADVANCE_FLAG(D_030046a8->data.advanceFlags, ADVANCE_FLAG_DISABLE_RUMBLE) ? "‚r‚‚Ž‚“" : "‚`‚–‚…‚ƒ";
#endif
        case OPTIONS_BITMAP_SKIP_DISCLAIMER:
            return CHECK_ADVANCE_FLAG(D_030046a8->data.advanceFlags, ADVANCE_FLAG_SKIP_DISCLAIMER) ? "‚o‚‚“‚“‚…‚’" : "‚l‚‚Ž‚”‚’‚…‚’";

        case OPTIONS_BITMAP_ALT_GAME_SELECT_MUSIC:
            return CHECK_ADVANCE_FLAG(D_030046a8->data.advanceFlags, ADVANCE_FLAG_USE_ALT_GAME_SELECT_MUSIC) ? "‚b‚ˆ‚‚Ž‚‡‚…‚’" : "‚c‚¬‚†‚‚•‚”";
    }
