...
struct DebugMenuEntry debug_menu_entry_table[] = {
 ...
 /* Drum LIVE */ {
    ...
    /* Spaceball (Unused 2) */ {
        ...
        /* Label */ "‚a‚‚“‚…‚‚‚‚Œ‚Œ@‚ë‚ì‚í‚„@‚Qj",
        /* Epil. */ TRUE
    },
    /* Snappy Trio (Unused) */ {
        /* Scene */ &scene_snappy_trio_unused,
        /* Label */ "‚s‚’‚‰‚@‚—‚…‚“‚”‚…‚’‚Ž@‚ƒ‚Œ‚‚@‚ë‚ì‚í‚î",
        /* Epil. */ TRUE
    },
    /* Rap Women (by KAZU) */ {
