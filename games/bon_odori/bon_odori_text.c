...
const char text_bon_odori_hanabi_agare_ba[] = ".0:0" "Ｈィａｂｉ　ａｇａｒｅ　ｂａ～";
...
const char text_bon_odori_dondo_pan_pan[] = ".1:0" "Ｄァア　" ".2:0" "ｐィ　ｐィ";

const char text_bon_odori_haa[] = ".0:0" "Ｈａａ～　Ａｈ～";

const char text_bon_odori_kansei_agaru[] = ".0:0" "Ｋィｓｅｉ　ａｇａｒｕ～";
...
const char text_bon_odori_nippon_chu_ga_wasshoi[] = ".0:0" "Ｎｉｐｐァ　ｃｈｕｕ　ｇａ　ｗａｓｓｈｏｉ！";
...
const char text_bon_odori_ha_bon_odori[] = ".0:0" "Ｈａａ～　Ｂァ　Ｏアｒｉ～";

const char text_bon_odori_dondo_panpa[] = ".1:0" "Ｄァア　" ".2:0" "ｐィｐａ";
...
const char text_bon_odori_in_japan[] = ".0:0" "ｍａｄｅ　ｉｎ　Ｊａ" ".2" "Ｐィ";

const char text_bon_odori_pan_pan[] = ".2:0" "Ｐィ　ｐィ";

const char text_bon_odori_don_don_pan_pan_2[] = ".1:0" "Ｄァ　ｄァ　" ".2:0" "ｐィ　ｐィ";

const char D_08067a84[] = ".6:1" "Ｂｉｅｎｖｅｎｕｅ　ａｕ　ｆｅｓｔｉｖａｌ　ｄｕ　Ｂァ　Ｏアｒｉ　！";

const char D_08067aa4[] = ".6:1" "Ｔａｐｅｚ　ｄｅｓ　ｍａｉｎｓ　ｑｕィｄ　ァ　ｄｉｔ　《　Ｐィ　》　！";

const char D_08067ad0[] = ".6:0" "Ｂｉｅｎ　！";

const char D_08067adc[] = ".6:1" "Ｔａｐｅｚ　２　ｆｏｉｓ　ｑｕィｄ　ァ　ｄｉｔ　《　Ｐィｐａ　》　！";
